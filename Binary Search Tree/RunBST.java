...
public class RunBST {
	...
	while (true) {
		...
		case 't': // For testing
			tree.addElement(Integer.valueOf(8));
			tree.addElement(Integer.valueOf(3));
			tree.addElement(Integer.valueOf(1));
			tree.addElement(Integer.valueOf(6));
			tree.addElement(Integer.valueOf(4));
			tree.addElement(Integer.valueOf(7));
			tree.addElement(Integer.valueOf(10));
			tree.addElement(Integer.valueOf(14));
			tree.addElement(Integer.valueOf(13));
			display.repaint();
		break;
